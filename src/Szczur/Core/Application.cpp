...
namespace rat {
	Application::Application() {
		...
		/*_modules.getModule<MusicMenager>().push({
			"R1",
			"R2",
			"R3",
			"R4"
		...
		_modules.getModule<MusicMenager>()[0]->setPlayingMode(Playlist::PlayingMode::Orderly);
		_modules.getModule<MusicMenager>()[0]->play();*/
